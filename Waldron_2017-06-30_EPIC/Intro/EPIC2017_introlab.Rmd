...
opts_chunk$set(eval=FALSE, cache=TRUE, autodep=TRUE)
```
...
This  `r Biocpkg("phyloseq")` objects contain 3 components, with extractor functions hinted at by its show method:
...
[html]: http://rpubs.com/lwaldron/EPIC2017_introlab
