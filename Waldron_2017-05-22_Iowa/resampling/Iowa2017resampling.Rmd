...
\tiny
ISLR Chapter 5: James, G. _et al._ An Introduction to Statistical Learning: with Applications in R. (Springer, 2013). 

This book can be [downloaded for free](http://www-bcf.usc.edu/~gareth/ISL/getbook.html).
...
* Join CUNY's statistical learning book club
* We meet online to learn and do data science:
    + schedule: http://tinyurl.com/huw8cb5
    + announcements: https://groups.google.com/forum/#!forum/stat_learning
    + materials: https://github.com/waldronlab/Book_Club
...
[html]: http://rpubs.com/lwaldron/Iowa2017resampling
[source]: https://github.com/waldronlab/presentations/tree/master/Waldron_2017-05-22_Iowa/resampling
