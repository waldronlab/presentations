---
title: "Bioc2017 MultiAssayExperiment Lab"
vignette: >
...
With ranged objects in the MultiAssayExperiment, you can then do subsetting by ranges. For example, select all genes on chromosome 1 for the four 
*rangedSummarizedExperiment* objects:
```{r}
rseACC[GRanges(seqnames="1:1-1e9"), , 1:4]
```
...
acc <- curatedTCGAData("ACC", 
                assays=c("miRNASeqGene", "RPPAArray", "Mutation", "RNASeq2GeneNorm"), dry.run=FALSE)
acc
```
