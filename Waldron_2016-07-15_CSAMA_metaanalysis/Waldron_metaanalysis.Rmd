...
downloader::download("https://bitbucket.org/lwaldron/ovrc4_sigvalidation/raw/tip/input/patientselection.config", destfile="patientselection.config")
...
```{r createesetlist, results="hide", message=FALSE, warning=FALSE}
